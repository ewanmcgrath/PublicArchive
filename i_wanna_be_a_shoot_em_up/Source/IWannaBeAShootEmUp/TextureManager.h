...
public:
	...
	void printText(std::string text, int x, int y, int width, int height, SDL_Renderer *pRenderer, SDL_Color);
...
private:
	...
	TextureManager& operator=(const TextureManager&); // TODO: This is a singleton, this operation should never happen.
