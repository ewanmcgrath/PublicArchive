                                    ...
                                    m_bPlayedDeathSound(false)
{
	...
	m_Attributes.m_health = 0;
	m_Attributes.m_damage = 0;
	m_Attributes.m_firingRate = 0;
	m_Attributes.m_luck = 0;
	m_Attributes.m_movementSpeed = 0;
	m_Attributes.m_projectileSpeed = 0;
}
