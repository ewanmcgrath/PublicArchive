...
int BulletHandler::getPlayerBulletDamage()
{
...
void BulletHandler::addPlayerBullet(int x, int y, int width, int height, std::string textureID, int numFrames, Vector2D heading, int playerDamage)
{
	...
	playerBulletDamage = playerDamage;
