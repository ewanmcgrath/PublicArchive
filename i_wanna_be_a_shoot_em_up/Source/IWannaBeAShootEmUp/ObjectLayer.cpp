...
void ObjectLayer::update(Level* pLevel)
{
	...
	m_collisionManager.checkPlayerPickupCollision(pLevel->getPlayer(), (const std::vector<GameObject*>&)m_gameObjects);
	...
	m_collisionManager.checkBulletTileCollision(pLevel->getCollidableLayers());
}
