...
m_cameraTarget(0.0f, 15.0f, 15.0f),
...
void BulletOpenGLApplication::Keyboard(unsigned char key, int x, int y) {
	...
	case '1':
		CreateGameObject(new btSphereShape(0.5f), 1.0, btVector3(1.0f, 0.2f, 0.2f), btVector3(1.0f, 100.0f, 40.0f));
		break;
	case '2':
		CreateGameObject(new btSphereShape(0.5f), 1.0, btVector3(0.66f, 0.134f, 0.244f), btVector3(9.0f, 100.0f, 40.0f));
		break;
	case '3':
		CreateGameObject(new btSphereShape(0.5f), 1.0, btVector3(0.193f, 0.65f, 1.0f), btVector3(13.0f, 100.0f, 40.0f));
		break;
	case '4':
		CreateGameObject(new btSphereShape(0.5f), 1.0, btVector3(0.122f, 1.0f, 0.65f), btVector3(-9.0f, 100.0f, 40.0f));
		break;
	case '5':
		CreateGameObject(new btSphereShape(0.5f), 1.0, btVector3(0.9f, 0.8f, 0.45f), btVector3(-13.0f, 100.0f, 40.0f));
		break;
	case 'w':
...
/*ADD*/		case COMPOUND_SHAPE_PROXYTYPE:
/*ADD*/			{
/*ADD*/				// get the shape
/*ADD*/				const btCompoundShape* pCompound = static_cast<const btCompoundShape*>(pShape);
/*ADD*/				// iterate through the children
/*ADD*/				for (int i = 0; i < pCompound->getNumChildShapes(); ++i) {
/*ADD*/					// get the transform of the sub-shape
/*ADD*/					btTransform thisTransform = pCompound->getChildTransform(i);
/*ADD*/					btScalar thisMatrix[16];
/*ADD*/					thisTransform.getOpenGLMatrix(thisMatrix);
/*ADD*/					// call drawshape recursively for each child. The matrix
/*ADD*/					// stack takes care of positioning/orienting the object for us
/*ADD*/					DrawShape(thisMatrix, pCompound->getChildShape(i), color);
/*ADD*/				}
/*ADD*/				break;
/*ADD*/			}
...
void BulletOpenGLApplication::ShootBox(const btVector3 &direction) 
{
	...
	GameObject* pObject = CreateGameObject(new btSphereShape(1.0f), 1.0, btVector3(1.0f, 0.2f, 0.2f), m_cameraPosition);
